...
const u8 gText_PokeSum_Controls_Page_Regular[] = _("{DPAD_LEFTRIGHT}PAGE {A_BUTTON}REG");
const u8 gText_PokeSum_Controls_Page_IV[] = _("{DPAD_LEFTRIGHT}PAGE {A_BUTTON}IV");
const u8 gText_PokeSum_Controls_Page_EV[] = _("{DPAD_LEFTRIGHT}PAGE {A_BUTTON}EV");
